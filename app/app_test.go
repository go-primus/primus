...
func TestApp_Endpoint(t *testing.T) {
	v := []string{"https://go-primus.dev", "localhost"}
...
func TestApp_buildInstance(t *testing.T) {
	want := struct {
		...
		endpoints: []string{"https://go-primus.dev", "localhost"},
	}
	var endpoints []*url.URL
	...
	tests := []fields{
		{
			id:       "1",
			name:     "primus-v1",
			instance: &registry.ServiceInstance{Endpoints: []string{"https://go-primus.dev", "localhost"}},
			metadata: map[string]string{},
			version:  "v1",
			want: struct {
				id       string
				...
				id: "1", version: "v1", name: "primus-v1", endpoint: []string{"https://go-primus.dev", "localhost"},
				metadata: map[string]string{},
			},
		},
		{
			...
			metadata: map[string]string{"primus": "https://github.com/go-primus/primus"},
			version:  "v2",
			want: struct {
				id       string
				version  string
				...
				id: "2", version: "v2", name: "primus-v2", endpoint: []string{"test"},
				metadata: map[string]string{"primus": "https://github.com/go-primus/primus"},
			},
		},
		{
			...
			want: struct {
				...
				id: "3", version: "v3", name: "primus-v3", endpoint: nil,
				metadata: map[string]string{},
			},
		},
	}
