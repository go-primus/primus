...
func TestNewEndpoint(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{"https", "github.com/go-primus/primus/"},
			want: &url.URL{Scheme: "https", Host: "github.com/go-primus/primus/"},
		},
		{
			name: "https://go-primus.dev/",
			args: args{"https", "go-primus.dev/"},
			want: &url.URL{Scheme: "https", Host: "go-primus.dev/"},
		},
		{
...
func TestParseEndpoint(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:    "primus",
			args:    args{endpoints: []string{"https://github.com/go-primus/primus"}, scheme: "https"},
			want:    "github.com",
			wantErr: false,
		},
		{
			name:    "test",
			args:    args{endpoints: []string{"http://go-primus.dev/"}, scheme: "https"},
			want:    "",
			wantErr: false,
		},
		{
